...
public class MelbourneWeatherTimeLapseStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService(
				"MelbourneWeatherTimeLapse" + getUniqueSuffix());
		...
		__operation.setName(new javax.xml.namespace.QName(
				"http://MelbourneWeatherTimeLapse", "getWeather"));
		...
		__operation.setName(new javax.xml.namespace.QName(
				"http://MelbourneWeatherTimeLapse", "getLocations"));
		_service.addOperation(__operation);
	...
	private void populateFaults() {
		...
		faultExceptionNameMap.put(new org.apache.axis2.client.FaultMapKey(
				new javax.xml.namespace.QName(
						"http://MelbourneWeatherTimeLapse", "Exception"),
				"getWeather"), "melbourneweathertimelapse.ExceptionException");
		...
		faultMessageMap
				.put(new org.apache.axis2.client.FaultMapKey(
						new javax.xml.namespace.QName(
								"http://MelbourneWeatherTimeLapse", "Exception"),
						"getWeather"),
						"melbourneweathertimelapse.MelbourneWeatherTimeLapseStub$ExceptionE");
	...
	public MelbourneWeatherTimeLapseStub(
	 ...
	 */
	public MelbourneWeatherTimeLapseStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault {
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					...
					public void onMessage(
						...
						try {
							...
							callback.receiveResultgetWeather((melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetWeatherResponse) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap
									...
									try {
										...
										if (ex instanceof melbourneweathertimelapse.ExceptionException) {
											callback.receiveErrorgetWeather(ex);
											return;
										}

										callback.receiveErrorgetWeather(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
					...
					public void onMessage(
						...
						try {
							...
							java.lang.Object object = fromOM(
									...
									melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetLocationsResponse.class,
									getEnvelopeNamespaces(resultEnv));
							callback.receiveResultgetLocations((melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetLocationsResponse) object);
	...
	public static class GetLocationsResponse implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://MelbourneWeatherTimeLapse", "getLocationsResponse",
				"ns2");
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (local_returnTracker) {
				if (local_return != null) {
					...
					// write null attribute
					writeStartElement(null, "http://MelbourneWeatherTimeLapse",
							"return", xmlWriter);
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			if (local_returnTracker) {
				if (local_return != null) {
					...
					elementList.add(new javax.xml.namespace.QName(
							"http://MelbourneWeatherTimeLapse", "return"));
					elementList.add(null);
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(
			...
			if ("http://MelbourneWeatherTimeLapse".equals(namespaceURI)
	...
	public static class GetWeather implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://MelbourneWeatherTimeLapse", "getWeather", "ns2");
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":getWeather", xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "getWeather", xmlWriter);
				}
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			if (localLocationTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://MelbourneWeatherTimeLapse", "location"));
						...
						if (fullTypeName != null) {
							...
							if (!"getWeather".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (GetWeather) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	public static class ExceptionE implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://MelbourneWeatherTimeLapse", "Exception", "ns2");
	...
	public static class GetWeatherResponse implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://MelbourneWeatherTimeLapse", "getWeatherResponse", "ns2");
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":getWeatherResponse",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "getWeatherResponse", xmlWriter);
				}
						...
						if (fullTypeName != null) {
							...
							if (!"getWeatherResponse".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (GetWeatherResponse) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	public static class Exception implements
		 ...
		 * Exception Namespace URI = http://MelbourneWeatherTimeLapse Namespace
		 * Prefix = ns2
		 */
	...
	private org.apache.axiom.om.OMElement toOM(
			melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetWeather param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetWeather.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetWeatherResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetWeatherResponse.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
			melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.ExceptionE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.ExceptionE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
			melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetLocationsResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetLocationsResponse.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetWeather.class
					.equals(type)) {

				return melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetWeather.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetWeatherResponse.class
					.equals(type)) {

				return melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetWeatherResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.ExceptionE.class
					.equals(type)) {

				return melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.ExceptionE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetLocationsResponse.class
					.equals(type)) {

				return melbourneweathertimelapse.MelbourneWeatherTimeLapseStub.GetLocationsResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
